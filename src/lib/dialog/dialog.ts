...
export class WPDialog {
    ...
    open(component: any, data?: any): Promise<WPDialogRef> {
    ...
    private _resolveOpen(component: any, data: any, done: (dialogRef: WPDialogRef) => void) {
        this._contRef.clear();
        const cmpFactory = this.cfr.resolveComponentFactory(component);
        const dialogRef = new WPDialogRef(this._contRef, data);
        const injector = Injector.create([
            { provide: WPDialogRef, useValue: dialogRef }
        ], this.injector);
